...
abstract class BaseAuthRepository {
  ...
  Future<Either<Failure,Unit>> signUpParent(SignUpParentParameters signUpParentParameters);
  Future<Either<Failure,Unit>> signUpNewStudent(SignUpNewStudentParameters signUpNewStudentParameters);
  Future<Either<Failure,Unit>> signUpExistingStudent(SignUpExistingStudentParameters signUpExistingStudentParameters);
